...
# from kitti_utils import read_calib
...
class KittiDataset(Dataset):
  ...
  This Dataset implementation gets- ROIFlow, which is just crops of valid
    ...
    """
    def __init__(
        self, ann_file, root, remove_images_without_annotations, return_names=False, transforms=None
    ):
    ...
    def __getitem__(self, idx):
        ...
        calib_path = os.path.join(self.calib_dir, self.label_paths[idx])
        ...
        if not self.return_names:
            ...
            return img, target, self.image_paths[idx], calib
